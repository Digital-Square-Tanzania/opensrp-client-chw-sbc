...
public class BaseTestRegisterFragmentPresenter implements TestRegisterFragmentContract.Presenter {

    protected WeakReference<TestRegisterFragmentContract.View> viewReference;
    ...
    public BaseTestRegisterFragmentPresenter(TestRegisterFragmentContract.View view, TestRegisterFragmentContract.Model model, String viewConfigurationIdentifier) {
    ...
    protected TestRegisterFragmentContract.View getView() {
