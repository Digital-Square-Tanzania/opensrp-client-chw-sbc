...
import org.smartregister.chw.barebones.util.ConfigHelper;
...
public class BaseTestRegisterFragmentModel implements TestRegisterFragmentContract.Model {

    @Override
    public RegisterConfiguration defaultRegisterConfiguration() {
        return ConfigHelper.defaultRegisterConfiguration(TestLibrary.getInstance().context().applicationContext());
    }
