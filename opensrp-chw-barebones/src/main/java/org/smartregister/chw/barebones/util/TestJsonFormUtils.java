...
import static org.smartregister.chw.barebones.util.Constants.ENCOUNTER_TYPE;
import static org.smartregister.chw.barebones.util.Constants.STEP_ONE;
import static org.smartregister.chw.barebones.util.Constants.STEP_TWO;
...
public class TestJsonFormUtils extends org.smartregister.util.JsonFormUtils {
    ...
    protected static FormTag formTag(AllSharedPreferences allSharedPreferences) {
        ...
        formTag.appVersion = TestLibrary.getInstance().getApplicationVersion();
        formTag.databaseVersion = TestLibrary.getInstance().getDatabaseVersion();
        return formTag;
    }
    ...
    public static void tagEvent(AllSharedPreferences allSharedPreferences, Event event) {
        ...
        event.setClientApplicationVersion(TestLibrary.getInstance().getApplicationVersion());
        event.setClientDatabaseVersion(TestLibrary.getInstance().getDatabaseVersion());
    }
    ...
    public static JSONObject getFormAsJson(String formName) throws Exception {
        return FormUtils.getInstance(TestLibrary.getInstance().context().applicationContext()).getFormJson(formName);
    }
