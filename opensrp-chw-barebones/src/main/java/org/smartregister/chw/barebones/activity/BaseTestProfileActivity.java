...
import org.smartregister.chw.barebones.custom_views.BaseTestFloatingMenu;
import org.smartregister.chw.barebones.dao.TestDao;
import org.smartregister.chw.barebones.domain.MemberObject;
import org.smartregister.chw.barebones.interactor.BaseTestProfileInteractor;
...
public class BaseTestProfileActivity extends BaseProfileActivity implements TestProfileContract.View, TestProfileContract.InteractorCallBack {
    protected MemberObject memberObject;
    protected TestProfileContract.Presenter profilePresenter;
    ...
    protected BaseTestFloatingMenu baseTestFloatingMenu;

    public static void startProfileActivity(Activity activity, String baseEntityId) {
        Intent intent = new Intent(activity, BaseTestProfileActivity.class);
    ...
    protected void onCreation() {
        ...
        toolbar.setNavigationOnClickListener(v -> BaseTestProfileActivity.this.finish());
        ...
        memberObject = TestDao.getMember(baseEntityId);
        initializePresenter();
    ...
    protected void initializePresenter() {
        ...
        profilePresenter = new BaseTestProfilePresenter(this, new BaseTestProfileInteractor(), memberObject);
        fetchProfileData();
    ...
    public void initializeFloatingMenu() {
        if (StringUtils.isNotBlank(memberObject.getPhoneNumber())) {
            baseTestFloatingMenu = new BaseTestFloatingMenu(this, memberObject);
            baseTestFloatingMenu.setGravity(Gravity.BOTTOM | Gravity.RIGHT);
            LinearLayout.LayoutParams linearLayoutParams = new LinearLayout.LayoutParams(
                    LinearLayout.LayoutParams.MATCH_PARENT,
                    LinearLayout.LayoutParams.MATCH_PARENT);
            addContentView(baseTestFloatingMenu, linearLayoutParams);
        }
    }
